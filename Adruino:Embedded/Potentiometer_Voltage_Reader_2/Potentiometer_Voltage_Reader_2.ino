//Reads analog voltage from an input pin using the ESP32's ADC (Analog-to-Digital Converter) and displays the voltage value.
//Unlike the first voltage reader, this one: 
//incorporates IDF-SDK functions for ADC readings.
