//This code measures distance using echolocation (the same method used by bats when flying in the night). 
//The ultrasonic ranging module has four pins: VCC, Trig, Echo, and GND
// N
